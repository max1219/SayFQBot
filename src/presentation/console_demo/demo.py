...
async def start_demo():
    ...
    print("Send request to unregistered:", await friendship_service.request_friendship_by_name(0, "None"))
    print("Send request normal:", await friendship_service.request_friendship_by_name(0, "One"))
    await friendship_service.request_friendship_by_name(0, "Two")
    await friendship_service.request_friendship_by_name(0, "Three")
